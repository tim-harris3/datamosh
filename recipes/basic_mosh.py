...
footage with no cuts (like media/truck.AVI) reads as ONE giant shot, so every
segment moshes the whole clip -- for that kind of footage use
splice_from_examples.py, which chops it into random sections first.
"""

from datamosh import MoshConfig, run_mosh

cfg = MoshConfig(
    source="media/[z303-as043] Adult Swim 10.30.05.mkv",  # any video; relative to the project folder
