...
cfg = MoshConfig(
    # --- what / where / how much ---------------------------------------------
    source="media/sample.avi",  # video to extract shots from (python -m datamosh.sample)
    ...
    # audio_grain_range=(1, 3),          # loop-stretch grain length (chunks, ~32ms; smaller = smoother)
)
